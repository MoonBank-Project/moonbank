...
{
  m_ui->setupUi(this);
  m_ui->m_version->setText(QString(tr("MoonBank Desktop %1")).arg(Settings::instance().getVersion()));
...
{
  QDesktopServices::openUrl(QUrl("https://github.com/MoonBank-core/MoonBank/wiki", QUrl::TolerantMode));
}
