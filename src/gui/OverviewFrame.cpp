...
namespace WalletGui
{
  ...
  void OverviewFrame::onPriceFound(QJsonObject &result)
  {
    ...
    QString bank = QLocale(QLocale::system()).toString(currency, 'f', 2);
    ...
    m_ui->m_ccx->setText(currentCurrency + " " + bank);
  ...
  /* Update the total portfolio in BANK and Fiat on the top left hand corner */
  void OverviewFrame::updatePortfolio()
  {
    ...
    m_ui->ccxTotal->setText(tr("Total") + " " + CurrencyAdapter::instance().formatAmount(OverviewFrame::totalBalance) + " BANK ");
  ...
  void OverviewFrame::bankingClicked()
  {
    ...
    if (walletSynced == true)
    {
      m_ui->m_myMoonBankWalletTitle->setText(tr("BANKING"));
  ...
  {
    m_ui->darkness->hide();
    m_ui->m_myMoonBankWalletTitle->setText(tr("TRANSACTIONS"));
  ...
  {
    m_ui->darkness->hide();
    m_ui->m_myMoonBankWalletTitle->setText(tr("MoonBank"));
  ...
  {
    m_ui->darkness->hide();
    m_ui->m_myMoonBankWalletTitle->setText(tr("ABOUT"));
  ...
  {
    m_ui->darkness->hide();
    m_ui->m_myMoonBankWalletTitle->setText(tr("WALLET SETTINGS"));
  ...
  {
    m_ui->darkness->hide();
    m_ui->m_myMoonBankWalletTitle->setText(tr("INBOX"));
  ...
  void OverviewFrame::newTransferClicked()
  {
    ...
    if (walletSynced == true)
    {
      m_ui->m_myMoonBankWalletTitle->setText(tr("SEND FUNDS"));
  ...
  void OverviewFrame::newMessageClicked()
  {
    ...
    if (walletSynced == true)
    {
      m_ui->m_myMoonBankWalletTitle->setText(tr("NEW MESSAGE"));
  ...
  void OverviewFrame::setAddress(const QString &_address)
  {
    ...
    else
    {
      ...
      m_ui->m_myMoonBankWalletTitle->setText(tr("SEND MESSAGE"));
      m_ui->m_titleIcon->setPixmap(QPixmap(":/icons/icon-send-message"));
      m_ui->newMessageBox->raise();
    }
  }
  ...
  void OverviewFrame::onAddressFound(const QString &_address)
  {
    ...
    if ((!_address.isEmpty()) && (connection != "embedded"))
    {
      ...
      m_ui->m_sendFee->setText("Fee: 0.011000 BANK");
      m_ui->m_messageFee->setText("Fee: 0.011000 BANK");
      m_ui->m_depositFeeLabel->setText("0.011000 BANK");
    }
  }
  ...
  void OverviewFrame::sendFundsClicked()
  {
    ...
    try
    {
      ...
      {
        /* Parse the record and set address to the actual BANK address */
        std::vector<std::string> records;
        if (!Common::fetch_dns_txt(address.toStdString(), records))
        {
          QCoreApplication::postEvent(&MainWindow::instance(), new ShowMessageEvent(tr("Failed to lookup MoonBank ID"), QtCriticalMsg));
        }
    ...
    {
      QCoreApplication::postEvent(&MainWindow::instance(), new ShowMessageEvent(tr("Could not check MoonBank ID"), QtCriticalMsg));
      return;
    }
  ...
  {
    m_ui->m_myMoonBankWalletTitle->setText(tr("ADDRESS BOOK"));
  ...
  {
    QDesktopServices::openUrl(QUrl("https://discord.gg/9G3emf7jfj", QUrl::TolerantMode));
  }

  void OverviewFrame::twitterClicked()
  {
    QDesktopServices::openUrl(QUrl("https://twitter.com/MoonBankProject", QUrl::TolerantMode));
  }

  void OverviewFrame::telegramClicked()
  {
    QDesktopServices::openUrl(QUrl("https://t.me/MoonBank_Project", QUrl::TolerantMode));
  }

  void OverviewFrame::githubClicked()
  {
    QDesktopServices::openUrl(QUrl("https://github.com/MoonBank-Project", QUrl::TolerantMode));
  }

  void OverviewFrame::redditClicked()
  {
    QDesktopServices::openUrl(QUrl("https://t.me/MoonBank_Announcement", QUrl::TolerantMode));
  }
